...
import getData from '@salesforce/apex/Documentmergecomponent_Controller.getData';
import getRecordsId from '@salesforce/apex/Documentmergecomponent_Controller.getRecordsId';

export default class Documentmergecomponent extends NavigationMixin(LightningElement) {
    debugger;
    @api recordId;
    docData = []
    error
